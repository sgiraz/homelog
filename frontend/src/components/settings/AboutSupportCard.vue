    ...
    <div class="flex items-start gap-3">
      ...
      <div class="flex-1 min-w-0">
        <div class="flex items-center gap-2 flex-wrap">
          <h3 class="font-semibold text-ink">{{ t('settings.about.title') }}</h3>
          <span v-if="appVersion" class="text-xs text-ink-faint tabular-nums">v{{ appVersion }}</span>
          <a
        ...
        <p class="text-sm text-ink-muted mt-1">{{ t('settings.about.tagline') }}</p>
